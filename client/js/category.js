$(document).ready(function() {
    let getAllCategoryURL = "http://localhost/products-api/api/category/read_all_products.php";
    let createCategoryURL = "http://localhost/products-api/api/category/create_product.php";
    let updateCategoryURL = "http://localhost/products-api/api/category/update_product.php";
    let deleteCategoryURL = "http://localhost/products-api/api/category/delete_product.php";
